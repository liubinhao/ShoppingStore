...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img src="/images/taotao-logo.gif" alt="shop商城"></a></div>
</div>
...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="payment" value="<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value=""/>"/>
...
<div class="shopping-list ABTest">
	<div class="goods-list">
     <!--配送方式-->
    <h4 class="vendor_name_h" id="0">商家：shop商城</h4>		         
			...
			<div class="goods-msg">
				...
				<div class="p-price">
					...
					<strong>￥<fmt:formatNumber
							...
							minFractionDigits="2" value="" /></strong>
					<!--增加预售金额显示 end-->
		...
		<div class="mode-tab-nav">
			<ul>
				<li class="mode-tab-item " id="jd_shipment_item"
					...
					id="jdShip-span-tip" class="m-txt">shop快递<i
						class='qmark-icon qmark-tip'
						data-tips='由shop公司负责配送，速度很快，还接受上门刷卡付款服务'></i></span><b></b></li>
			</ul>
		</div>
	</div>
</div>
		...
		<div class="order-summary">
			...
			<div class="statistic fr">
				<div class="list">
					...
					<em class="price" id="warePriceId">¥<fmt:formatNumber value="" maxFractionDigits="2" minFractionDigits="2" groupingUsed="true"/></em>
				</div>
				<div class="list">
				...
				<div class="list">
					<span>应付总额：</span> <em class="price" id="sumPayPriceId">
						￥<fmt:formatNumber value="" maxFractionDigits="2" minFractionDigits="2" groupingUsed="true"/></em>
				</div>
			</div>
			<div class="clr"></div>
		</div>
      ...
      <div class="sticky-wrap">
          ...
          <button type="submit" class="checkout-submit btn-1" 
          	...
          	提交订单
                    ...
                    <span class="total">应付总额：<strong id="payPriceId">￥<fmt:formatNumber value="" maxFractionDigits="2" minFractionDigits="2" groupingUsed="true"/></strong>
          </span>
